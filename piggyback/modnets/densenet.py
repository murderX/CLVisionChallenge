...
def densenet121(mask_init='1s', mask_scale=1e-2, threshold_fn='binarizer', **kwargs):
...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, mask_init, mask_scale, threshold_fn):
...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate, mask_init, mask_scale, threshold_fn):
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features, mask_init, mask_scale, threshold_fn):
...
class DenseNet(nn.Module):
    ...
    def __init__(self, mask_init, mask_scale, threshold_fn, growth_rate=32,
